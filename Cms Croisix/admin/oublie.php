...
<div id="pageadmin">
 	...
 	<form action="oublie.php" method="post" name="FormName" class="adminform">

		<fieldset>	

			<legend>Pour obtenir votre mot de passe, veuillez saisir votre adresse e-mail d'inscription</legend>

				<ol>

				    <li>

				      <label for="textLogin">Adresse e-mail :</label> <input type="text" name="textLoginOublie">
					  <input id="button" type="submit" value="valider"> </li>
					  </li>
